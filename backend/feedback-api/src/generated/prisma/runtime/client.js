...
function xn(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [rp(e, t), ip(e, t), Pt(r), $('name', () => t), $('$name', () => t), $('$parent', () => e._appliedParent)];
  return W({}, n);
}
function rp(e, t) {
  let r = X(t),
...
function hr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
  ...
  let o = e(t, i, r) ?? t;
  return (
    r.include && zo({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    r.select && zo({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    o
  );
}
function zo({ includeOrSelect: e, result: t, parentModelName: r, runtimeDataModel: n, visitor: i }) {
...
function At(e) {
  if (typeof e != 'object' || e == null || (0, Te.isObjectEnumValue)(e) || Ue(e) || Q(e)) return e;
...
var Or = class {
  ...
  #a(t, r) {
    if (re(r, te.ParamEnum) && r.enumNameIndex !== void 0 && typeof t == 'string') {
    ...
    async #r(t) {
      if (t.newTxId)
        return await this.#p(t.newTxId, 'start', async s => {
          if (s.status !== 'running')
            throw new ne(`Transaction in invalid state ${s.status} when starting a nested transaction.`);
          if (!s.transaction)
            throw new ne('Transaction missing underlying driver transaction when starting a nested transaction.');
          s.depth += 1;
          let a = this.#i(s);
          s.savepoints.push(a);
          try {
      ...
      switch (
        ...
        case 'committed':
        case 'rolled_back':
          throw new ne(`Transaction in invalid state ${r.status} although it just finished startup.`);
        default:
      ...
      return await this.tracingHelper.runInChildSpan('commit_transaction', async () => {
        await this.#p(t, 'commit', async r => {
          if (r.depth > 1) {
            ...
            if (!n) throw new ne(`Missing savepoint for nested commit. Depth: ${r.depth}, transactionId: ${r.id}`);
            try {
      ...
      return await this.tracingHelper.runInChildSpan('rollback_transaction', async () => {
        await this.#p(t, 'rollback', async r => {
          if (r.depth > 1) {
            if (!r.transaction) throw new Re();
            let n = r.savepoints.at(-1);
            if (!n) throw new ne(`Missing savepoint for nested rollback. Depth: ${r.depth}, transactionId: ${r.id}`);
            try {
      ...
      if (!n) {
        ...
        if (i)
          switch ((et('Transaction already closed.', { transactionId: t, status: i.status }), i.status)) {
            ...
            case 'waiting':
            case 'running':
              throw new ne('Active transaction found in closed transactions list.');
            case 'committed':
              throw new Nr(r);
            case 'rolled_back':
              throw new Dr(r);
