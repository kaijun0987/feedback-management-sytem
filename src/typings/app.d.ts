...
declare namespace App {
    ...
    type Schema = {
      ...
      page: {
        ...
        feedback: {
          ...
          filterAllForms: string;
          filterNormalCase: string;
          filterSpecialCase: string;
          adminPortal: string;
          changePassword: string;
          changePasswordSuccessTitle: string;
          changePasswordSuccessContent: string;
          login: string;
          logout: string;
          anonymousSubmit: string;
          anonymousSubmitHint: string;
          perFormAnonymousHint: string;
          browseForms: string;
          ...
          clearFilters: string;
          retry: string;
          changePasswordComingSoon: string;
          formDetailNotReady: string;
          loadFormsError: string;
          filteredEmpty: string;
          empty: string;
          submitSuccessTitle: string;
          submitSuccessAnonymous: string;
          submitSuccessNamed: string;
          submitUpdatedTitle: string;
          submitUpdatedAnonymous: string;
          submitUpdatedNamed: string;
          submitFailed: string;
          changePasswordModal: {
            title: string;
          ...
          summary: {
            openForms: string;
            openFormsHint: string;
            specialCases: string;
            specialCasesHint: string;
            totalResponses: string;
            totalResponsesHint: string;
          };
          shared: {
            caseType: {
              all: string;
        ...
        feedbackManage: {
          ...
          createForm: string;
          viewDashboardComingSoon: string;
          searchPlaceholder: string;
          selectCase: string;
          selectStatus: string;
          ...
          summary: {
            totalForms: string;
            totalFormsHint: string;
            enabledForms: string;
            enabledFormsHint: string;
            endingSoon: string;
            endingSoonHint: string;
            totalResponses: string;
            totalResponsesHint: string;
          };
          columns: {
        ...
        userManage: {
          ...
          loadFailed: string;
          saveFailed: string;
          onlySuperEditAdmin: string;
          adminOnlyCommonUsers: string;
          ...
          summary: {
            ...
            totalAccountsHint: string;
            adminAccounts: string;
            adminAccountsHint: string;
            commonUsers: string;
            commonUsersHint: string;
            activeAccounts: string;
            activeAccountsHint: string;
          };
          columns: {
            user: string;
            role: string;
        ...
        feedbackForm: {
          builder: {
            ...
            questionTitleRequired: string;
            choiceOptionsRequired: string;
          ...
          response: {
            ...
            summary: {
              ...
              sampleCoverageHint: string;
            };
            anonymousResponse: string;
            unknownUser: string;
            noResponsesYet: string;
            noAnswer: string;
            noData: string;
            empty: string;
            noSampleResponses: string;
            topAnswer: string;
            mostSelected: string;
            sample: string;
            ratings: string;
  ...
  namespace Service {
    /** Other baseURL key */
    type OtherBaseURLKey = 'demo' | 'feedback';
